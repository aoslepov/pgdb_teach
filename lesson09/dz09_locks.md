...
-- при попытке обновить все строки во второй сессии (573) необходима эксклюзивная блокировка, 
-- но её держит первая сессия (564), транзакция страновится в очередь
